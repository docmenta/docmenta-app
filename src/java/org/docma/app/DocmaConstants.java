...
public class DocmaConstants
{
    ...
    public static final String DISPLAY_APP_VERSION = "1.8.1";
    public static final String DISPLAY_APP_SHORTNAME = "Docmenta";
    public static final String DISPLAY_APP_NAME_BASEEDITION = "Docmenta Open Source Edition";
    ...
    public static final String DISPLAY_APP_CREDIT = "Produced with Docmenta Publishing System V1.8 &#169; 2016 (www.docmenta.org)";
